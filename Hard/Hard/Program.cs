...
namespace ConsoleApplication1
{
    ...
    {
        void Command(IRobot robot1, IRobot robot2);
    }

    interface ICompRobot : IRobot
    {
        void CompCommand(IRobot robot1, IRobot robot2);
    }
    ...
    class Robot : IMyRobot, ICompRobot
    {
        ...
        public void Shot(IRobot RobotEnemy)
        {
            if (QuantityBullet == 0)
            {
            ...
            else
            {
                ...
                if (RobotEnemy.ArmorValue >= GenRandN) RobotEnemy.ArmorValue -= GenRandN;
                else if (RobotEnemy.ArmorValue == 0) RobotEnemy.HP -= GenRandN;
                else
                {
                    int MinusHP = GenRandN - RobotEnemy.ArmorValue;
                    RobotEnemy.ArmorValue = 0;
                    RobotEnemy.HP -= MinusHP;
                }
        ...
        public void Command(IRobot robot1, IRobot robot2)
        {
        ...
        public void CompCommand(IRobot robot1, IRobot robot2)
        {
        ...
        static void Main(string[] args)
        {
            ...
            while (!GameOver)
            {
                ...
                if (CRobot.HP > 0)
                {
                    ...
                    MRobot.Info();
                    CRobot.Info();
                    CRobot.CompCommand(CRobot, MRobot);
